...
begin
  ...
  if TAccountComp.TxtToMoney(ebDefaultFee.Text,df) then begin
    if df < CT_MinTransactionFee then begin
      df := CT_MinTransactionFee;
      ebDefaultFee.Text := TAccountComp.FormatMoney(CT_MinTransactionFee);
    end;
    AppParams.ParamByName[CT_PARAM_DefaultFee].SetAsInt64(df);
  end else begin
    ebDefaultFee.Text := TAccountComp.FormatMoney(AppParams.ParamByName[CT_PARAM_DefaultFee].GetAsInteger(CT_MinTransactionFee));
...
begin
  ...
  Try
    ...
    ebDefaultFee.Text := TAccountComp.FormatMoney(AppParams.ParamByName[CT_PARAM_DefaultFee].GetAsInt64(CT_MinTransactionFee));
